...
public class EditDoctorPanel extends JPanel implements ActionListener{
	...
	private JTextField doctor_idField;
	...
	private DoctorController doctorcontroller=null;
	private ArrayList<DoctorModel> doctorobjects=null;
	
	public EditDoctorPanel(AdminController _controller) {
		setLayout(null);
		controller = _controller;
		if(controller.getDoctorController()==null)
		{
		...
		{
			doctorcontroller=controller.getDoctorController();
		}

		doctorobjects=doctorcontroller.getDoctorObjects();
		...
		JLabel lblAddCotor = new JLabel("Edit Doctor");
		...
		JLabel lblDoctorId = new JLabel("Doctor");
		...
		JLabel lblDocotorId = new JLabel("Doctor Id");
		...
		doctor_idField = new JTextField();
		doctor_idField.setColumns(10);
		doctor_idField.setBounds(169, 324, 126, 22);
		add(doctor_idField);
		
		comboBox = new JComboBox(doctorcontroller.getDoctorList().toArray());
		comboBox.setBounds(167, 104, 263, 20);
		add(comboBox);
		comboBox.addActionListener(this);
		firstNameField.setText(doctorobjects.get(comboBox.getSelectedIndex()).getFirst_name());
		middleNameField.setText(doctorobjects.get(comboBox.getSelectedIndex()).getMiddle_name());
		lastNameField.setText(doctorobjects.get(comboBox.getSelectedIndex()).getLast_name());
		streetField.setText(doctorobjects.get(comboBox.getSelectedIndex()).getStreet());
		cityField.setText(doctorobjects.get(comboBox.getSelectedIndex()).getCity());
		department_idField.setText(Integer.toString(doctorobjects.get(comboBox.getSelectedIndex()).getDepartment_code()));
		zipField.setText(doctorobjects.get(comboBox.getSelectedIndex()).getZip());
		phoneField.setText(doctorobjects.get(comboBox.getSelectedIndex()).getPhone());
		emailField.setText(doctorobjects.get(comboBox.getSelectedIndex()).getEmail());
		admin_idField.setText(Integer.toString(doctorobjects.get(comboBox.getSelectedIndex()).getAdmin_id()));
		doctor_idField.setText(Integer.toString(doctorobjects.get(comboBox.getSelectedIndex()).getDoctor_id()));
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getActionCommand().toString().equals("Save"))
		{
			DoctorModel dm=doctorobjects.get(comboBox.getSelectedIndex());
			dm.setFirst_name(firstNameField.getText());
			
			dm.setMiddle_name(middleNameField.getText());
			
			dm.setLast_name(lastNameField.getText());
			
			dm.setStreet(streetField.getText());
			
			dm.setCity(cityField.getText());
			
			dm.setDepartment_code(Integer.parseInt(department_idField.getText()));
			dm.setZip(zipField.getText());
			
			dm.setPhone(phoneField.getText());
			
			dm.setEmail(emailField.getText());
			dm.setAdmin_id(Integer.parseInt(admin_idField.getText()));
			dm.setAdmin_id(Integer.parseInt(doctor_idField.getText()));
			...
			try {
		      System.out.println(dm.getFirst_name());
				doctorcontroller.updateDoctorRecord(dm);
			} catch (Exception exe) {
				exe.printStackTrace();
			}
		}
