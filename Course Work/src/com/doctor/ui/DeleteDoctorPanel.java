...
public class DeleteDoctorPanel extends JPanel implements ActionListener{
	...
	public DeleteDoctorPanel(AdminController _controller) {
		setLayout(null);
		...
		doctor_idField.setEditable(false);
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getActionCommand().toString().equals("Delete"))
		{
			try {
				...
				doctorcontroller.deleteDoctorRecord(doctorobjects.get(comboBox.getSelectedIndex()));
			} catch (Exception exe) {
				exe.printStackTrace();
			}
		}
