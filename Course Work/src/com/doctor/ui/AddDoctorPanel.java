...
public class AddDoctorPanel extends JPanel {
	...
	private DoctorModel doctormodel=null;
	private DoctorController doctorcontroller=null;
	public AddDoctorPanel(AdminController _controller) {
		setLayout(null);
		...
		JLabel lblAddCotor = new JLabel("Add Doctor");
		...
		btnCreate.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				doctormodel.setFirst_name(firstNameField.getText());
				doctormodel.setLast_name(lastNameField.getText());
				doctormodel.setMiddle_name(middleNameField.getText());
				doctormodel.setStreet(streetField.getText());
				doctormodel.setCity(cityField.getText());
				doctormodel.setZip(zipField.getText());
				doctormodel.setEmail(emailField.getText());
				doctormodel.setPhone(phoneField.getText());
				doctormodel.setDepartment_code(Integer.parseInt(department_idField.getText()));
				doctormodel.setAdmin_id(Integer.parseInt(admin_idField.getText()));
				doctormodel.setDoctor_id(Integer.parseInt(doctor_idField.getText()));
				
				
				
				doctorcontroller.addDoctorRecord(doctormodel);
			}
		});
		...
		doctor_idField.setBounds(169, 292, 126, 22);
		add(doctor_idField);
