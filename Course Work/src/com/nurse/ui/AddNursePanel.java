...
public class AddNursePanel extends JPanel {
	...
	public AddNursePanel(AdminController _controller) {
		setLayout(null);
		...
		JLabel lblAddCotor = new JLabel("Add Nurse");
		...
		btnCreate.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				nursemodel.setFirst_name(firstNameField.getText());
				nursemodel.setLast_name(lastNameField.getText());
				nursemodel.setMiddle_name(middleNameField.getText());
				nursemodel.setStreet(streetField.getText());
				nursemodel.setCity(cityField.getText());
				nursemodel.setZip(zipField.getText());
				nursemodel.setEmail(emailField.getText());
				nursemodel.setPhone(phoneField.getText());
				nursemodel.setDepartment_code(Integer.parseInt(department_idField.getText()));
				nursemodel.setAdmin_id(Integer.parseInt(admin_idField.getText()));
				nursemodel.setNurse_id(Integer.parseInt(nurse_idField.getText()));
				
				
				
				nursecontroller.addNurseRecord(nursemodel);
			}
		});
		...
		nurse_idField.setBounds(169, 292, 126, 22);
		add(nurse_idField);
