...
public class DeleteNursePanel extends JPanel implements ActionListener{
	...
	public DeleteNursePanel(AdminController _controller) {
		setLayout(null);
		...
		JLabel lblAddCotor = new JLabel("Delete Nurse");
		...
		nurse_idField.setEditable(false);
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getActionCommand().toString().equals("Delete"))
		{
			...
			nursecontroller.deleteNurseRecord(nurseobjects.get(comboBox.getSelectedIndex()));
			} catch (Exception exe) {
				exe.printStackTrace();
			}
		}
