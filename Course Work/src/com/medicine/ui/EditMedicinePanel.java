...
public class EditMedicinePanel extends JPanel implements ActionListener {
	...
	public EditMedicinePanel(PharmacistController _controller) {
		setLayout(null);
		...
		JLabel lblAddMedicine = new JLabel("Edit Medicine");
	...
	public void actionPerformed(ActionEvent e) {
		if(!e.getActionCommand().toString().equals("Update"))
		{
		...
		if(e.getActionCommand().toString().equals("Update"))
		{
			MedicineModel mm=medicineobjects.get(comboBox.getSelectedIndex());
			mm.setName(nameField.getText());
			
			mm.setForm(formField.getText());
			
			mm.setDose(doseField.getText());
			
			mm.setPharmacist_id(Integer.parseInt(pharmacistIDField.getText()));
			
			mm.setRoute(routeField.getText());
			
			
			try {
		      System.out.println(mm.getName());
				medicinecontroller.updateMedicineRecord(mm);
			} catch (Exception exe) {
				exe.printStackTrace();
			}
		}
