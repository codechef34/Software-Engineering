...
This class is used to create the UI for the client 
...
/**
This function is used to make a game request by the user to the opponent user
...
**/
	...
	/**
             This function is used to disconnect the user or client from the server
...
/**
This method is used to update the list of the users who is connected to the server
