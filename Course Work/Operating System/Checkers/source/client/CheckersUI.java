...
/**
* This is the class which is used to create the graphical user interface for the checkers board 
...
/**
*   This is the function which is used to fill the checkers board with the red and black pieces
...
/**
*  This is the function which is used move the pieces by the users
*/
...
/**
     This function is used to check whether the game is finished or not.
	 If either red pieces or black pieces becomes zero then we can say that game is finished
**/
        ...
        try {
            if ( red_piece_count == 0 || black_piece_count == 0) {
                ...
                if ( playerColor.equals ( current.side ) ){
                    ...
                    JOptionPane.showMessageDialog ( null, client.me.getName()+ "You Win" );
                }
                else {
                    client.matchList.remove(oppoName);
                    client.clientsList.remove ( opponent );
                    logger.logit(oppoName + "- wins the match\n");
                    JOptionPane.showMessageDialog ( null, oppoName + "You lost" );
                }
            }
        }
        catch ( IOException ex ) {}
...
/**
*   This function is used to check whether the move made by the user is legal or not
     If the move is not legal then the user can cannot move the piece to the desired location
...
**/
	...
	/**
	This function is used to move the piece to the particular location the user desired in the board 
...
/**
This function is used to make the piece as the king if it reaches the end part
**/
