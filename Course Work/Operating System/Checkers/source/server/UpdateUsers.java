 ...
 * This class is used to update the new client users requested or to remove the clients from the list who have disconnected
 *
 *
 * 
 */
public class UpdateUsers extends Thread {
     ...
     * Method description
     *
     * This method accepts the parameter name of the client and removes fron the users list who is connected to the client
     * @param name
     *
     * @throws IOException
     */
